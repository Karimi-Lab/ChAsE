...
public class ClustFramework
{
    ...
    /**
     * Set the seed for the kmeans random number generator 
     * @param randomSeed seed for random number generator. use 0 for random seed
     */
    public void setKmeansSeed(long randomSeed) {
        m_KmeansSeed = randomSeed;
    }
    
    /**
     * Returns the current seed for kmeans random number generator
     * @return
     */
    ...
    public void kmeans(ClustInfo cInfo, int K) {
        ...
        Random rnd = (m_KmeansSeed == 0) ? new Random() : new Random(m_KmeansSeed);
        for (int c = 0; c < K; ++c)
        {
