...
public class ExportPlotDialog extends JPanel implements ActionListener, ChangeListener
{
    ...
    public ExportPlotDialog() 
    {
        ...
        panelOptions.add(new JLabel("Stroke Width:"));
        m_SpinnerStrokeWidth = new JSpinner(new SpinnerNumberModel(5, 1, 100, 1));
        m_SpinnerStrokeWidth.setMaximumSize(new Dimension(70, 25));
        m_SpinnerStrokeWidth.setAlignmentX(LEFT_ALIGNMENT);
        panelOptions.add(m_SpinnerStrokeWidth);
		...
		m_ModalDialog.setMinimumSize(new Dimension(600, 200));
    ...
    {
    	return (Integer) m_SpinnerStrokeWidth.getValue();
    }
