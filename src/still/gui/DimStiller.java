...
public class DimStiller extends JFrame implements 	ActionListener,
	...
	JMenuItem newBioMenuItem		= null;
	JMenuItem newEQTLMenuItem		= null;
...
//			System.exit(0);
		...
		eTreePanel.setPreferredSize( new Dimension(800,200));
		eTreePanel.reSelect();
		
		controlView.setPreferredSize( new Dimension(800,300));
		// lay out
...
//		sidePanel.add(tempGridPanel,"Center");
		splitPane = new JSplitPane( JSplitPane.VERTICAL_SPLIT, eTreePanel, controlView);
		...
		newBioMenuItem		= new JMenuItem("New Biological Expression");
		newEQTLMenuItem		= new JMenuItem("New eQTL Expression");
		...
		fileMenu.add(newBioMenuItem);
		fileMenu.add(newEQTLMenuItem);
		...
		newBioMenuItem.addActionListener(this);
		newEQTLMenuItem.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if( e.getSource() == newBioMenuItem ) {

			// create a new expression			
			Table t = BioTableFactory.procTable( this.getContentPane() );
			if( t != null ) {
		...
		else if( e.getSource() == newEQTLMenuItem ) {

			// create a new expression			
			Table t = EQTLTableFactory.eQTLTable( this.getContentPane() );
			if( t != null ) {
